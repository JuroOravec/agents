...
import { type PrdReviewOptions, runPrdReview } from '../mastra/workflows/demo-prd-review.js';
...
// Re-export for programmatic use (e.g. ai-crew-run skill)
export {
  DEMO_PRD,
  type PrdReviewOptions,
  type RefinedPRD,
  runPrdReview,
} from '../mastra/workflows/demo-prd-review.js';
